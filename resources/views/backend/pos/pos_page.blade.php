                    ...
                    <div class="card text-center">
                        <div class="card-body">
                                                ...
                                                <td>
                                                    <form action="{{ url('/cart-update/' . $cart->rowId) }}" method="POST">
                                                        ...
                                                        <input type="number" value="{{ $cart->qty }}"
                                                            style="width:40px; weight:40px;" min="1" name="qty">
                                                        <button type="submit" class="btn btn-sm btn-success"
                                                            style="margin-top:-3px;"><i class="fas fa-check"></i></button>
                                                    </form>
                                                </td>
                                                <td>Rp.{{ $cart->price }}</td>
                                                <td>Rp.{{ $cart->subtotal }}</td>
                                                <td> <a href="{{ url('/cart-delete/' . $cart->rowId) }}"><i
                            ...
                            <div class="bg-primary">
                                ...
                                <p style="font-size:18px; color:#fff"> Discount : {{ Cart::tax() }} </p>
                                <p>
