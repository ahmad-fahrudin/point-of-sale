                                        ...
                                        <div class="col-12">
                                            <div class="form-check mb-2 form-check-primary">
                                                <input class="form-check-input" type="checkbox" value=""
                                                    id="customcheck15">
                                                <label class="form-check-label" for="customcheck15">Select All</label>
                                            </div>
                                        </div>
                                        <hr>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-check mb-2 form-check-primary">
                                                        ...
                                                        <label class="form-check-label"
                                                            for="customcheck15">{{ $group->group_name }}</label>
                                                    </div>
                                                </div>
                                                <div class="col-9">
                                                    @php
                                                    ...
                                                    @foreach ($permissions as $permission)
                                                        <div class="form-check mb-2 form-check-primary">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                id="customcheck15{{ $permission->id }}">
                                                            <label class="form-check-label"
                                                                for="customcheck15{{ $permission->id }}">{{ $permission->name }}</label>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            </div> <!-- end row -->
